...
if (isset($_GET['EmpID'])) {
    ...
    $sql_select = "SELECT * FROM employee WHERE EmpID = $EmpID";
...
$sql = "UPDATE employee SET Fname='$new_Fname',Lname='$new_Lname',Gender='$new_Gender',DOB='$new_DOB',Email='$existing_Email',Address='$new_Address',ManagerID='$existing_ManagerID', BasicSalary='$existing_salary' WHERE EmpID = $EmpID";
...
<html lang="en">
    ...
    <form method="POST">
        <div class=content>
            ...
            <input type="text" id="new_Email" name="new_Email" value="<?php echo $existing_Email; ?>" disabled><br><br>
            
            <lable for="new_ManagerID">ManagerID:</lable>
            <input type="number" id="new_ManagerID"name="new_ManagerID" value="<?php echo $existing_ManagerID; ?>" disabled><br><br>
            <lable for="new_BasicSalary">Basic Salary:</lable>
            <input type="number" id="new_salary"name="new_salary" value="<?php echo $existing_salary; ?>" disabled><br><br>
        </div>
